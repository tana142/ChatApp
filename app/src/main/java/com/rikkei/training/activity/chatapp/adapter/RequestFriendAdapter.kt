...
class RequestFriendAdapter(val list: MutableList<User>) :
    RecyclerView.Adapter<RequestFriendAdapter.ViewHolder2>() {
    class ViewHolder2(val item: ItemRequestedBinding) : RecyclerView.ViewHolder(item.root) {
        fun init(user: User) {
